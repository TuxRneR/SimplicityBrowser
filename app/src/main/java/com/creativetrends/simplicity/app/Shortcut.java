...
public class Shortcut extends AppCompatDialogFragment {
    // The public interface is used to send information back to the activity that called Shortcut.
    ...
    // Check to make sure that the activity that called Shortcut implements both listeners.
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        Drawable favoriteIconDrawable = new BitmapDrawable(getResources(), SimplicityActivity.favoriteIcon);
        ...
        alertDialogBuilder.setNegativeButton(R.string.cancel, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                buttonListener.onCreateHomeScreenShortcutCancel(Shortcut.this);
            }
        });
        alertDialogBuilder.setPositiveButton(R.string.create, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                buttonListener.onCreateHomeScreenShortcutCreate(Shortcut.this);
            }
        });
